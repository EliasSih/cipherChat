...
import static src.GenerateCertificate.encodeCertificate;
                    ...
                    if (parts.length == 2) {
                        ...
                        if (cert != null) {
                            if (GenerateCertificate.verifyCertificate(cert)) {
                                ...
                                // and encode key
                                out.println("@keyResponse:" + requestedClientName + ":" + encodeCertificate(cert));

                                System.out.println("@keyResponse:" + requestedClientName + ":" + encodeCertificate(cert));
                            }
                            else {
